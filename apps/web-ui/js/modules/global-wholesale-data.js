...
export const GLOBAL_WHOLESALE_MARKETS = Object.freeze([
  ...
  Object.freeze({ id: 'dubai', country: '阿联酋', city: '迪拜', marketName: '迪拜阿维尔果蔬市场', region: '中东', coordinates: Object.freeze([55.37, 25.18]), modes: Object.freeze(['AIR', 'SEA']), demoPriceIndex: 1.12, demoBorderCostPct: 5, complianceHint: '需核对清真/标签要求、进口商资质、温控记录与口岸查验。' }),
  Object.freeze({ id: 'rotterdam', country: '荷兰', city: '鹿特丹', marketName: '鹿特丹食品中心', region: '欧洲', coordinates: Object.freeze([4.48, 51.92]), modes: Object.freeze(['AIR', 'RAIL', 'SEA']), demoPriceIndex: 0.98, demoBorderCostPct: 7, complianceHint: '需核对欧盟植物健康、农残、可追溯、包装和进口商责任。' }),
  Object.freeze({ id: 'london', country: '英国', city: '伦敦', marketName: '新考文特花园市场', region: '欧洲', coordinates: Object.freeze([-0.14, 51.49]), modes: Object.freeze(['AIR', 'RAIL']), demoPriceIndex: 1.05, demoBorderCostPct: 7, complianceHint: '需核对英国植物检疫、农残标准、进口申报与冷链承运能力。' }),
  Object.freeze({ id: 'los-angeles', country: '美国', city: '洛杉矶', marketName: '洛杉矶农产品批发市场', region: '北美', coordinates: Object.freeze([-118.24, 34.05]), modes: Object.freeze(['AIR', 'SEA']), demoPriceIndex: 1.1, demoBorderCostPct: 10, complianceHint: '需核对美国农业部与口岸检疫、州级要求、进口商资质和标签规则。' }),
  Object.freeze({ id: 'toronto', country: '加拿大', city: '多伦多', marketName: '安大略食品批发中心', region: '北美', coordinates: Object.freeze([-79.5, 43.63]), modes: Object.freeze(['AIR', 'SEA']), demoPriceIndex: 1.04, demoBorderCostPct: 6, complianceHint: '需核对加拿大食品检验局进口条件、双语标签、农残和冷链记录。' }),
  Object.freeze({ id: 'sydney', country: '澳大利亚', city: '悉尼', marketName: '悉尼批发市场', region: '大洋洲', coordinates: Object.freeze([151.0, -33.87]), modes: Object.freeze(['AIR', 'SEA']), demoPriceIndex: 1.18, demoBorderCostPct: 10, complianceHint: '需核对严格生物安全准入、处理证明、进口许可与温控。' }),
  Object.freeze({ id: 'sao-paulo', country: '巴西', city: '圣保罗', marketName: '圣保罗州仓储与批发中心', region: '南美', coordinates: Object.freeze([-46.72, -23.54]), modes: Object.freeze(['AIR', 'SEA']), demoPriceIndex: 0.88, demoBorderCostPct: 11, complianceHint: '需核对巴西农业主管部门的植物检疫、进口许可、葡语标签与口岸清关。' })
]);
