...
export const AdminDecisionView = {
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      isCommandSuccess, metrics, dataLabel, metricSource, executionLabel, passportCounts, decisionTraceId, humanTime, RISK_META, runDecisionChain, loadApprovalPlan, choosePlot, createEvidenceRequest,
