...
import { AdminResourcePlanningView } from './admin-resource-planning.js?v=20260831-agent-history-v1';
import { metricStatusLabel, priorityLabel, provenanceLabel, statusLabel } from '../live-data.js?v=20260831-agent-history-v1';
