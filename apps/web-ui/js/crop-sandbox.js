...
const SCENARIO_PRESETS = {
  normal: {
    ...
    trackA_loss: 'SIMULATED · 未预测损失',
    trackB_benefit: 'SIMULATED · 处方保持待命',
  ...
  drought: {
    ...
    humidity: 32,
    rootCauses: [
      { name: 'DERIVED · 土壤缺水 (WATER_DEFICIT)', prob: 94, color: '#f85149' },
    ...
    trackA_loss: 'SIMULATED · 减产风险 38%（估算）',
    trackB_benefit: 'SIMULATED · 处方试算补水 153L',
  ...
  heatwave: {
    ...
    trackA_loss: 'SIMULATED · 严重灼伤风险（估算）',
    trackB_benefit: 'SIMULATED · 微喷降温试算 280L',
  ...
  flood: {
    ...
    trackA_loss: 'SIMULATED · 沤根减产风险（估算）',
    trackB_benefit: 'SIMULATED · 建议排涝并禁止灌溉',
    desc: '模拟田间含水率超过 90% 时，规则将禁止灌溉并生成排涝工单草案。'
  },
  drift: {
    id: 'drift',
    ...
    rootCauses: [
      ...
      { name: 'DERIVED · 作物生理状态健康', prob: 95, color: '#3fb950' },
      { name: 'DERIVED · 缺水证据不足 (置信度 < 5%)', prob: 95, color: '#3fb950' }
    ],
    forecastCurve: [
    ...
    trackA_loss: 'SIMULATED · 作物状态保持健康',
    trackB_benefit: 'SIMULATED · 拦截 180L 错误灌溉试算',
    desc: '模拟读数突降至 11% 时，多源证据规则将其分流为传感器漂移，并拒绝生成可执行灌溉处方。'
  },
  stuck: {
    id: 'stuck',
    ...
    trackA_loss: 'SIMULATED · 缺水干枯风险（估算）',
    trackB_benefit: 'SIMULATED · 转备用支管并人工复核',
      ...
      <header class="sandbox-header">
        ...
        <div class="sandbox-header-right">
          <div class="sandbox-status-chip">
            ...
            <span data-studio-status>SIMULATED · 3D 离线动力学推演</span>
          </div>
        </div>
      </header>
      ...
      <footer class="sandbox-bottom-scrubber">
        ...
        <div class="sandbox-value-ticker">
          <div class="sandbox-ticker-item">
            ...
            <span>模拟影响：</span>
            <strong data-ticker-loss style="color: #f85149;">SIMULATED · 减产风险 38%（估算）</strong>
          </div>
          <div class="sandbox-ticker-item">
            <i class="ph ph-drop" style="color: #58a6ff;"></i>
            <span>处方试算：</span>
            <strong data-ticker-benefit style="color: #3fb950;">SIMULATED · 补水 153L</strong>
          </div>
          <div class="sandbox-ticker-item">
            <i class="ph ph-clock" style="color: #bc8cff;"></i>
            <span>工时假设：</span>
            <strong>ESTIMATED · 2.5h（未计入真实效益）</strong>
          </div>
        </div>
      </footer>
    `;
