...
export const WorkOrderLifecycleView = {
  ...
  setup(props, { emit }) {
    ...
    return {
      ...
      openCreate, createTask, openAssign, refreshFarmMembers, assignTask, toggleOverdueSelection, toggleAllOverdue, autoReassignOverdue, autoDisposeOverdue, autoAssignUnassigned,
