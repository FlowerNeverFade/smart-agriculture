...
I-01/I-02、I-03、I-04、I-05、I-07/I-13、I-08、I-10/I-11、I-28、I-29、I-30 已形成可复现的农户端演示闭环。I-06/I-12、I-14、I-15 回归通过。在模拟数据源且就绪度满足安全门时，农户可确认并执行 `FARMER_VIRTUAL` 虚拟浇水；真实设备或证据不足仍转人工/管理员，不改变真实资源账本。
...
| I-30 | “我的地块”点击地块后只读展示管理员维护的模拟策略、当前场景、参数摘要和策略预测曲线，并可跳转风险预警展开；农户不可修改策略 | 待本轮浏览器验收 |
...
9. “我的地块”点击地块后展示当前模拟策略、场景芯片、参数摘要和策略预测曲线；点击“在风险预警中展开”进入同一地块的风险预测页，农户界面无保存/重置策略控件。
