...
| T-049 | P0 | 农户专用工作台：首页简化、地块指标/历史、风险与灌溉建议、巡田/补证、账户自助 | 前端 | — | 本轮 | 已完成 | `apps/web-ui/farmer.html`、`farmer.js`、`farmer.css`；四项统计卡及任务/消息直达、3 个授权地块网格、六项指标 SVG 趋势子图、灌溉建议土壤湿度曲线、1/2/4 小时风险参考、演示灌溉、规则问答/紧凑反馈、巡田与补证表单；本地浏览器地块切换/图表渲染/建议曲线、窄屏无横向溢出及运行时错误检查通过 |
