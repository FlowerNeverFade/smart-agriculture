...
| T-043 | P0 | 完成账号注册、身份选择与核验、恢复码重置、凭据轮换及登录页账户流程 | 前后端 | — | D15+ | 已完成（本地验证） | Flyway v2、身份匹配与安全注册 Gradle 回归、Vite 构建、本地 API 黑盒、登录/注册身份内置浏览器流程通过；`docs/account-management.md` |
