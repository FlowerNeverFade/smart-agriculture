...
| T-048 | P0 | 将账户与工作台角色收敛为农场管理员、种植农户、系统管理员，并迁移旧操作员范围 | 前后端 | — | 本轮 | 待验收 | `RolePolicy`/`roles.js` 三角色权限合同、Flyway `V4__three_role_scopes.sql`、三角色 Gradle 回归、登录页透明 Alpha Logo 与角色菜单/地块隔离；待推送远程 `main` 并核对远程提交 |
