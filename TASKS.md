...
>
> 当前 T-061、T-062、T-063、T-065、T-066、T-068、T-069、T-070、T-071 等待用户界面验收；T-067 仍在进行，T-064 已完成。界面改动在代码、自动化测试和构建完成后统一执行一次浏览器功能与视觉验收，提供功能清单和必要截图；复用已有页面，不在开发过程中反复截图。当前证据入口见 `docs/README.md`，已结束的分工计划、旧 3D 页面验收和历史截图由 Git 历史保存。
>
