...
| T-081 | P0 | 角色专用 `/farm-admin/` 与共享服务版本对齐 | 前后端 | T-076/T-078 | 本轮 | 进行中 | 合并 `origin/main@333e7cd` 后同步 `/srv/agriloop` 与 `/srv/farm-admin`；本地 Node 58/58、Gradle、Vite、Web real/stub/svg 38/38/37 和 1440×1000 Edge 视觉检查通过，待服务器发布与正式页面黑盒验收。 |
