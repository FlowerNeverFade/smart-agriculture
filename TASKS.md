...
| T-075 | P0 | AI 告警分析、批量直接派单与管理员完整对话页 | 前端 | T-056/T-068/T-070 | 本轮 | 待验收 | 入口更名为“AI告警分析与智能处理”；保留 main 的 `auto-fill/minmax(280px, 1fr)` 概要卡和居中详情，增加全选、批量直接下发、批量关闭和 AI 智能处理，移除“确认收到”、“升级处理”和“转成任务”。AI 按诊断置信度/缺失证据/规则状态审核，高可信告警按农户地块权限、当前工作量和过往地块经验选人并直接创建/分配工单；不确定或无合格农户时保留人工审核。农场管理员原诊断/灌溉页替换为完整 AI 对话，正文与输入为 16px。Node 32/32、Vite、Web real/stub/svg 24/24/23 通过；待用户本地视觉与交互验收。 |
