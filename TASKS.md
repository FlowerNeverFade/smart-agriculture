...
| 可视化主线 | D7-D8 | 今日农务、总览、曲线、核验、就绪度、设备、告警和控制 | 后端 REST/SSE 已完成；农田动态监测前端待验收，其他前端仍按原范围 |
...
| Gate 3 / D14 可答辩 | 基线、2 个 Crop Pack、测试、安全、固定演示；已启用 P1 切片有专属证据 | 后端已完成；农田监测前端待验收，完整答辩物料仍未完成 |
