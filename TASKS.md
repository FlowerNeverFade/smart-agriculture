...
| T-064 | P0 | AI 告警批量处置、可信度分流、智能派单与管理员对话页 | 前端 | — | 本轮 | 待验收 | 全选/批量下发/批量关闭；高可信告警按权限、任务量和地块经验自动派单，不确定项留待人工审核；管理员原诊断页替换为带地块上下文和历史的 AI 对话；Web 20/20、Vite、Gradle 与 Edge 正式登录/对话回归通过，待用户本地检查 |
