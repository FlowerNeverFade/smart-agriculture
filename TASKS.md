...
| T-045 | P1 | Web 等画质首屏与运行时性能优化 | 项目组 | — | D15+ | 已完成（公网验收） | `e9dc042`、`docs/acceptance/WEB_PERFORMANCE_ACCEPTANCE.md`；按需 JS/CSS、数据并行、18,816 株植被实例空间剔除、隐藏停帧、分级缓存；Chromium 15/15，Web real 79/79、stub/svg 78/78；公网登录/3D/按需模块/健康检查通过 |
