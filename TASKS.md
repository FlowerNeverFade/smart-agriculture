...
> 2026-08-25 本轮三角色收口已提交为 `ce98679ca3a6d0ba47b69eed54de9926b27664b6`，并已核对 GitHub `main` 指向同一提交；该动作只替换仓库分支，不代表公网服务部署。
...
| T-048 | P0 | 将账户与工作台角色收敛为农场管理员、种植农户、系统管理员，并迁移旧操作员范围 | 前后端 | — | 本轮 | 已完成 | `RolePolicy`/`roles.js` 三角色权限合同、Flyway `V4__three_role_scopes.sql`、三角色 Gradle 回归、透明 Alpha Logo、角色菜单/地块隔离；本地提交与 GitHub `main` 均为 `ce98679ca3a6d0ba47b69eed54de9926b27664b6` |
